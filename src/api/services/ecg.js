...
exports.makeEcgService = function () {
    return {
        upload: function (data, sub, jwt) {
            return new Promise(function (res, rej) { return __awaiter(void 0, void 0, void 0, function () {
                var payload, s3, params;
                var _a;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0: return [4 /*yield*/, aws_sdk_1.default.config.update(__assign(__assign({}, aws_sdk_1.default.config), { region: 'us-east-1', credentials: new aws_sdk_1.default.CognitoIdentityCredentials({
                                    IdentityPoolId: 'us-east-1:c6c201f9-b3f3-4c26-bf71-298384afd0be',
                                    Logins: (_a = {},
                                        _a["cognito-idp.us-east-1.amazonaws.com/" + poolData.UserPoolId] = jwt,
                                        _a)
                                }) }))];
                        case 1:
                            _b.sent();
